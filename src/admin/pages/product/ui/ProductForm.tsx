...
export const ProductForm = ({
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
    getValues, //Obtiene los valores del formalario sin un rerender
    setValue,
    watch, //Para hacer rerenders
  } = useForm<FormInputs>({
    //handlesubmit nos permite llamar a otra funcion si el formulario es valido
  ...
  const selectedSizes = watch("sizes"); //cada vez que cambie las tallas, haré un rerender. Para hacer el add más dinámico
  ...
  const addSize = (size: Size) => {
    const sizeSet = new Set(getValues("sizes")); //No graba duplicados, solo valores únicos
    sizeSet.add(size);
  ...
  const removeSize = (sizeToRemove: Size) => {
    ...
    // setValue(
    //   "sizes",
    //   sizeSet.filter((size) => size !== sizeToRemove),
    // );
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex justify-between items-center">
        ...
        <div className="flex justify-end mb-10 gap-4">
          ...
          {/*Siempre es bueno poner el type para que no envíe el formulario completo */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="number"
                      {...register("price", {
                        required: true, //Porque tiene que haber algo sí o sí
                        min: 1,
                      })}
                      className={cn(
                        "w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                  ...
                  {selectedTags.map((tag) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="ml-2 text-green-600 hov  er:text-green-800 transition-colors duration-200"
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </span>
                  ...
                  <input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " " || e.key === ",") {
                        e.preventDefault(); //Cuando doy enter, se envia todo el formulaio, no quiero eso, quiero que solo se envie este pedazo del código
                        addTag();
